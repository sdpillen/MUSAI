...
%
% MUPEX
% [results, data, EEG] = MUPEX_EEGtriggerTest(tg,info)
% by Til Ole Bergmann (mail@tobergmann.de)
% last edited 2017/10/04 by TOB
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [results, data, EEG] = MUPEX_EEGtriggerTest(tg,info)
...
ISI = 2.0; % inter stimulus interval (ISI) in ms. Always provide in ms, no matter which time resolution mode!
